/**
 * AddDoctor page component for admin panel.
 * Allows admin to add a new doctor with details and image upload.
 * Handles form state, validation, and API submission.
 *
 * @module pages/Admin/AddDoctor
 */
...
const AddDoctor = () => {
  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
      ...
      toast.error(error.message || "Failed to upload doctor image");
      return;
    }
  };
  ...
  return (
    <form onSubmit={onSubmitHandler} className="m-5 w-full">
      ...
      <div className=" w-full bg-white px-8 py-8 border rounded max-w-4xl max-h-[80vh] overflow-y-scroll">
