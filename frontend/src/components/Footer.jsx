      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="mb-6">
              <img className="h-12 w-auto mb-4" src={assets.logo} alt="MERO Doctor" />
              <p className="text-gray-300 leading-relaxed max-w-md">
                MERO Doctor is your trusted healthcare platform connecting patients with experienced medical professionals. 
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="/doctors" className="text-gray-300 hover:text-white transition-colors duration-300 flex items-center gap-2">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <a href="/privacy" className="text-gray-300 hover:text-white transition-colors duration-300 flex items-center gap-2">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-gray-300 text-sm">+977-9812693625</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-gray-300 text-sm">sanjyalsmiriti@gmail.com</p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700">
          <div className="max-w-md">
            ...
            <p className="text-gray-300 text-sm mb-4">Get the latest healthcare tips and updates delivered to your inbox.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-gray-400 text-sm">
              &copy; {new Date().getFullYear()} MERO Doctor. All rights reserved.
            </p>
